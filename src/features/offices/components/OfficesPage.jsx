    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">إدارة المكاتب الشريكة والفرق المرتبطة</p>
        </div>
          ...
          {offices.map((office) => (
            <div key={office.id} className="bg-[#111827]/60 rounded-2xl border border-white/5 overflow-hidden">
              <div className="p-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex gap-2">
                  {hasPermission(user, "offices.update") ? (
                  ...
                  {hasPermission(user, "offices.delete") && office.isActive ? (
                    <button
                      type="button"
                      onClick={() => {
              ...
              {expandedOfficeId === office.id ? (
                <div className="border-t border-white/5 p-5">
                  <OfficeMembersSection
                    office={office}
                    canManage={hasPermission(user, "offices.manageMembers")}
